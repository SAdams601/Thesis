...
This chapter will first begin with a discussion of the data refactorings for object oriented languages which helped inspire this thesis then there will be a brief discussion of  
