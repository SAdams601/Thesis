...
\section{Summary}
Automated refactoring have become well established parts of object oriented design environments. Refactoring tools for functional languages in recent years have expanded to offer greater customizability with domain specific languages and the ability to define refactorings using the target language instead of its internal representation directly.
