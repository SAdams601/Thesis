...
The type of types that Object-oriented languages support is normally quite limited. Java, for example, has a set of primitive types that are not user extensible, interfaces 
