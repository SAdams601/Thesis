...
What does this mean in practice? Take for example the following functions taken from this StackOverflow answer from Conor McBride~\citep{soApp}.
...
Both of these functions attempt to implement an if statement, \texttt{iffy} does it with \texttt{pure} and \texttt{(<*>)} whereas \texttt{miffy} uses the monadic functions. 
