...
Once all of the \texttt{Applicative} instances were discovered it was much easier to search through all of them to try and understand how the Haskell community is using the type class. For example the most common implementation for apply is simply \texttt{(<*>) = ap}, in 841 cases. This is the suggested implementation for apply in the case where the implementor of a new monad instance just wants their program to compile. 
