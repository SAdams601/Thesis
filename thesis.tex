...
renameXVar = everywhere (mkT rename)
	...
	The \texttt{everywhere} function is this traversal's generic combinator, \texttt{everywhere} applies the extended rename function to every node in the tree. Finally as you can see in the declaration of \texttt{Expr} that it derives both the Typeable and Data classes. A member of the Typeable class has defined a generic representation of itself and members of the Data class implement generic folding operations. Put together these two classes are what allow generic traversals. 
