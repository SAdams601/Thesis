...
\comment{Use the example produced by: https://github.com/SAdams601/HaRe/blob/mmp-refactoring/test/testdata/MaybeToMonadPlus/MMP2.hs.expected2 
to introduce projection functions and tease the next section on dlists
}
