...
\usepackage{courier}
\newcommand{\comment}[1]{\textcolor{red}{{\bf \tt  {#1}}}}
\usepackage{textcomp}
\lstset{
  frame=none,
  xleftmargin=2pt,
...
Implementing an automated refactoring system requires two primary dependencies, a frontend for the language that your refactorer targets, and a generic programming library. A language frontend is required for your refactorer to analyse and modify source code. A generic programming library is required to traverse the complex abstract syntax tree of a real world programming language. This chapter will cover how HaRe was originally implemented and how it has changed into it's current form. Additionally this chapter will outline the technologies that HaRe depends on, including the GHC API, ghc-exactprint, and Scrap Your Boilerplate (SYB). 

\todo{Do we want data refactoring to be in this chapter or in the intro?}  
